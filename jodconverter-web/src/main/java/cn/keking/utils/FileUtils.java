...
public class FileUtils {
    ...
    /**
     * url-FileAttribute缓存Map
     */
    private static Map<String,FileAttribute> urlFileAttributeMap = new ConcurrentHashMap<>();
    ...
    public FileAttribute getFileAttribute(String url) {
        ...
        if (!urlFileAttributeMap.containsKey(url)) {
            ...
            urlFileAttributeMap.put(url, new FileAttribute(type, suffix, fileName, url, decodedUrl));
        }
        return urlFileAttributeMap.get(url);
    }
}
